...
/**
 * The persistent class for the item_master_dtls database table.
 * 
 */
@Entity
@Table(name="item_master_dtls")
@NamedQuery(name="ItemMasterDtl.findAll", query="SELECT i FROM ItemMasterDtl i")
public class ItemMasterDtl implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7455004493445818678L;
