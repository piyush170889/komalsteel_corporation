...
/**
 * The persistent class for the user_address_dtls database table.
 * 
 */
@Entity
@Table(name="user_address_dtls")
@NamedQuery(name="UserAddressDtl.findAll", query="SELECT u FROM UserAddressDtl u")
public class UserAddressDtl implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2577369610911033577L;
