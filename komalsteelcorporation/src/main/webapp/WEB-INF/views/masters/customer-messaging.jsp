    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Unregistered Customer Messaging
          </h1>
				  ...
				  <!-- Any HTML and JSP TAG will go here -->   
		              ...
		              <div class="box box-info">
		                ...
		                <form class="form-horizontal" action="${pageContext.request.contextPath }/customer-messaging" method="POST">
		                  <div class="box-body">
		                    <div class="form-group">
		                      ...
		                      <div class="col-sm-2">
			                      <select class="form-control" name="smsType" onchange="showView(this.value)">
		                     ...
		                     <div class="form-group">
		                      <label for="inputPassword3" class="col-sm-2 control-label">Order No.: </label>
		                      ...
		                      <div class="col-sm-2">
								...
								<!-- LR NO -->
						      	<div id="LR_SMS" style="display:none;">
	                    			<div class="form-group">
						  				<label class="col-sm-2 control-label" for="tags">Transporter Name<i class="fa fa-asterisk" style="color:red;font-size:9px;"></i></label>
						  				<div class="col-sm-6">
						  					<input class="form-control" placeholder="Transporter Name" id="tags" name="transporterNm" />
						  				</div>
									</div>
			                    	
			                    	<div class="form-group">
			                      		<label class="col-sm-2 control-label" for="exampleInputPassword1">Destination<i class="fa fa-asterisk" style="color:red;font-size:9px;"></i></label>
			                      		<div class="col-sm-6">
			                    	...
			                    	<div class="form-group">
			                      		<label class="col-sm-2 control-label" for="exampleInputPassword1">Mark<i class="fa fa-asterisk" style="color:red;font-size:9px;"></i></label>
			                      		<div class="col-sm-6">
			                    	...
			                    	<div class="form-group">
			                      		<label class="col-sm-2 control-label" for="exampleInputPassword1">LR No</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
			                      		<div class="col-sm-6">
			                    	...
			                    	<div class="form-group">
			                      		<label class="col-sm-2 control-label" for="exampleInputPassword1">LR Date</label>
			                      		<div class="col-sm-6">
			                    	...
			                    	<div class="form-group">
			                      		<label for="exampleInputPassword1" class="col-sm-2 control-label" >No. Of Carton Loaded</label>
			                      		<div class="col-sm-6">
						...
						<div id="COURIER_SMS" style="display:none;" >
							<div class="form-group">
	                      		<label for="exampleInputPassword1" class="col-sm-2 control-label" >Courier Name<i class="fa fa-asterisk" style="color:red;font-size:9px;"></i></label>
								<div class="col-md-6">	
	                    	...
	                    	<div class="form-group">
	                      		<label for="exampleInputPassword1" class="col-sm-2 control-label" >Docate No.<i class="fa fa-asterisk" style="color:red;font-size:9px;"></i></label>
	                      		<div class="col-md-6">
	                      			<input class="form-control" placeholder="Docate No." id="docateNo1" name="docateNo" />
	                      		</div>
	                    	</div>
	                    	
	                    	<div class="form-group">
	                      		<label for="exampleInputPassword1" class="col-sm-2 control-label" >Delivery Date<i class="fa fa-asterisk" style="color:red;font-size:9px;"></i></label>
	                      		<div class="col-md-6">
