...
<!-- 
            ...
            <div class="row">
                <div class="col-md-6" >
                    <label style="align-content: left">Order Id : </label>${orderId}
                    <label style=" margin-left: 350px;">Date : </label>${userorderDetails.orderDate }
                </div>
            </div>
...
<div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <label style="align-content: left">Mark </label>
                    <c:choose>
                    ...
                    <label  style="margin-left:307px">Destination </label>
                    <c:choose>
