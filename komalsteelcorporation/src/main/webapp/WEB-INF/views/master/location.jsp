...
<html>
  <head>
    ...
    <title>Komal Industries | Location Details</title>
                      ...
                      <!-- Location Details -->
                        <c:forEach var="state" items="${statesList }">
                        	<tr>
                        		...
                        		<td>${state.locationName }</td>
                        		<td>${state.locationDesc }</td>
                        		<td>${state.isActive }</td>
                        		<td>
                        			<a data-toggle="modal" data-target="#editState" onclick="sendEditLocationValues('${state.locationId }','${state.locationName }'
                        			, '${state.locationDesc }', '${state.locationParentId }', '${state.isActive }')">
                        				<i class="fa fa-pencil" ></i>
                        			</a>
                        			<a href="locationdetails?stateid=${state.locationId }&statename=${state.locationName }">
                        				<i class="fa fa-eye" ></i>
                        			</a>
                        		</td>
                        	</tr>
...
<!-- Edit State Modal -->
<div id="editState" class="modal modal-primary fade" role="dialog">
  <div class="modal-dialog">
                ...
                <form role="form" action="locationdetailsedit" method="post" >
                  <div class="box-body" style="color:#333;">
        			...
        			<div class="col-md-6">
                     ...
                     <div class="form-group">
                      <label for="exampleInputPassword1">State Name</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
                      <input class="form-control" placeholder="State Name" type="text" name="locationName" required="required" id="locName1" />
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">States Desc</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
                      <input class="form-control" placeholder="States Desc" name="locationDesc"  type="text" required="required" id="locDesc1"/>
                    </div>
                  ...
                  <div class="box-footer">
                  	<input type="hidden" name="locationParentId" id="locParentId1"/>
