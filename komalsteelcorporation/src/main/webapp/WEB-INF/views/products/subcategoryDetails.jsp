              ...
              <div class="box">
                ...
                <div class="row">
                	<div class="col-xs-12">
						...
						<button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#addProduct">Add New SubCategory</button>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <!-- subcategory Details -->
                        <subcategory:subcategoryDetailsList productDAO="${subcategoryInjectedDAO }"/>
               <!--     <tr>
                  <td>1</td>
                  <td>service tax</td>
                  <td>10</td>
                  ...
                  <div class="box-body" style="color:#333;">
        			<div class="col-md-6">
                     <div class="form-group">
                      <label for="exampleInputPassword1">SubCategory Name</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
                      <input class="form-control" placeholder="Name" type="text" name="catName" required="required" />
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">SubCategory  Description</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
                      <input class="form-control" placeholder="Name" type="text" name="catDesc" required="required" />
                    </div>
                    </div>
                    <div class="col-md-6">
                    	<div class="form-group">
	                      <label for="exampleInputPassword1">SubCategory Image URL</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
	                      <input class="form-control" placeholder="Name" type="text" name="url" required="required" />
	                    </div>
                    	<div class="form-group">
	                      <label for="exampleInputEmail1">Select Category</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
	                       <!-- select -->
		                      <select class="form-control" id="category" name="parentId" required="required" >
		                          <option value="Select">Select</option>
		                          <subcategory:categoryList productDAO="${categoryInjectedDAO }"/>
		                      </select>
	                    </div>
                      <input class="form-control" placeholder=" Url" name="url"  type="hidden" value="" required="required" />
                      <input class="form-control" placeholder=" Url" name="isCategory"  type="hidden" value="false" required="required" />
                    </div>
                  </div>
                  <!-- /.box-body -->
      ...
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="editSubCatDetails" method="post" >
                  <div class="box-body" style="color:#333;">
        			<div class="col-md-6">
                      <input class="form-control" placeholder="SubCategory ID" type="hidden" id="SubCatId1" name="catId"  required="required" />
                     <div class="form-group">
                      <label for="exampleInputPassword1">SubCategory Name</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
                      <input class="form-control" placeholder="SubCategory Name" type="text" id="subCatName1" name="catName" required="required"/>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">SubCategory Image URL</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
                      <input class="form-control" placeholder="Name" type="text" name="url" id="url1" required="required" />
                    </div>
                    </div>
                    <div class="col-md-6">
                     <div class="form-group">
                      <label for="exampleInputEmail1">Select Category</label><i class="fa fa-asterisk" style="color:red;font-size:9px;"></i>
                       <!-- select -->
	                      <select class="form-control" id="parentId1" name="parentId" required="required" >
	                      <option value="Select">Select</option>
	                        <subcategory:categoryList productDAO="${categoryInjectedDAO }"/>
	                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder=" Url" id="subCatDesc1" name="catDesc" type="text"  />
                    </div>
                    </div>
                  </div>
                  <!-- /.box-body -->
