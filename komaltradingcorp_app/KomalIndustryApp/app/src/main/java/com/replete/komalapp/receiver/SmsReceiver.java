package com.replete.komalapp.receiver;
...
public class SmsReceiver extends BroadcastReceiver {
        ...
        try {
            if (bundle != null) {
                ...
                for (Object aPdusObj : pdusObj) {
                    ...
                    if (!senderAddress.toLowerCase().contains(ConfigUrls.SMS_ORIGIN.toLowerCase())) {
    ...
    private String getVerificationCode(String message) {
        String code = null;
        int index = message.indexOf(ConfigUrls.OTP_DELIMITER);
