...
import com.replete.komalapp.OnScrollListener;
 ...
 */
public class StaggeredGridView extends ViewGroup implements OnScrollListener {
...
//                final int colEnd = Math.min(mColCount, col + lp.span);
     ...
     * @param overhang     the number of content_main_new pixels to fill beyond the current top edge
...
//                highestView = 0;
     ...
     *
     * @param fromPosition Position to start filling from
     * @param overhang     the number of content_main_new pixels to fill beyond the current bottom edge
...
//                final int colEnd = Math.min(mColCount, nextCol + lp.span);
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        // If we don't have any content_main_new space, it will return one of the static state arrays,
        // and clearing the enabled state on those arrays is a bad thing!  If we specify
        // we need content_main_new space, it will create+copy into a new array that safely mutable.
     ...
     * @return The content_main_new information that should be returned by
